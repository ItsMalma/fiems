...
export default function PrintInsurance() {
  ...
  return (
    <Flex vertical style={{ minHeight: "100vh", padding: "1rem 4rem" }}>
      ...
      >
        <h1 style={{ fontSize: "16px", fontWeight: 600 }}>Insurance</h1>
        <p style={{ fontSize: "12px", fontWeight: 600 }}>
          Nomor: {insurance.number}
        </p>
      </Flex>
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>{insurance.jobOrder.inquiryDetail.inquiry.shipperName}</td>
            </tr>
            <tr>
              <td style={{ paddingRight: "0.5rem" }}>Alamat</td>
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{insurance.jobOrder.inquiryDetail.inquiry.shipperAddress}</td>
            </tr>
            <tr>
              <td style={{ paddingRight: "0.5rem" }}>Rute</td>
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{insurance.jobOrder.inquiryDetail.routeDescription}</td>
            </tr>
          </tbody>
        </table>
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{insurance.jobOrder.inquiryDetail.deliveryToName}</td>
            </tr>
            <tr>
              <td style={{ paddingRight: "0.5rem" }}>Consignee</td>
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{insurance.jobOrder.consigneeName}</td>
            </tr>
          </tbody>
        </table>
      </Flex>
      ...
      >
        <Flex align="flex-start" gap="middle" justify="center">
          <table>
            <tbody>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Nilai Tertanggung</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>
                  {new Intl.NumberFormat("id-ID", {
                    style: "currency",
                    currency: "IDR",
                  }).format(insurance.nilaiTertanggung)}
                </td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Premi</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.premi}</td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Premi Dibayarkan</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>
                  {new Intl.NumberFormat("id-ID", {
                    style: "currency",
                    currency: "IDR",
                  }).format(insurance.premiDibayarkan)}
                </td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Port Tujuan</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.inquiryDetail.portName}</td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>TD Jakarta</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>
                  {dayjs(insurance.jobOrder.td)
                    .locale("id")
                    .format("DD MMMM YYYY")}
                </td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Vessel</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.inquiryDetail.vesselName}</td>
              </tr>
            </tbody>
          </table>
          <table>
            <tbody>
              <tr>
                ...
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.containerNumber1}</td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Seal Number 1</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.sealNumber1}</td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Container Number 2</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.containerNumber2 || "-"}</td>
              </tr>
              <tr>
                <td style={{ paddingRight: "0.5rem" }}>Seal Number 2</td>
                <td style={{ paddingRight: "0.5rem" }}>:</td>
                <td>{insurance.jobOrder.sealNumber2 || "-"}</td>
              </tr>
            </tbody>
          </table>
        </Flex>
