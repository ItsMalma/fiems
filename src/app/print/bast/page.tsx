...
import { getBAST } from "@/actions/bast";
...
export default function PrintBAST() {
  ...
  return (
    <Flex vertical style={{ minHeight: "100vh", padding: "1rem 4rem" }}>
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>
                {bast.suratJalan.jobOrder.inquiryDetail.inquiry.shipperName}
              </td>
            </tr>
            <tr>
              ...
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>
                {bast.suratJalan.jobOrder.inquiryDetail.inquiry.shipperAddress}
              </td>
            </tr>
            <tr>
              <td style={{ paddingRight: "0.5rem" }}>Rute</td>
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{bast.suratJalan.jobOrder.inquiryDetail.routeDescription}</td>
            </tr>
          </tbody>
        </table>
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{bast.suratJalan.jobOrder.inquiryDetail.deliveryToName}</td>
            </tr>
            <tr>
              <td style={{ paddingRight: "0.5rem" }}>Consignee</td>
              <td style={{ paddingRight: "0.5rem" }}>:</td>
              <td>{bast.suratJalan.jobOrder.consigneeName}</td>
            </tr>
          </tbody>
        </table>
      </Flex>
      ...
      >
        <p>Nomor Surat Jalan : {bast.suratJalanNumber}</p>
        <Table
          bordered
          columns={[
          ...
          dataSource={bast.details}
          key="id"
          style={{ width: "100%" }}
          pagination={false}
        />
        <Flex vertical align="center">
          <p>Shipment / DO : {bast.suratJalan.doCustomer}</p>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td style={{ paddingRight: "0.5rem" }}>:</td>
                  <td>{bast.suratJalan.jobOrder.containerNumber1}</td>
                </tr>
                <tr>
                  <td style={{ paddingRight: "0.5rem" }}>Seal Number 1</td>
                  <td style={{ paddingRight: "0.5rem" }}>:</td>
                  <td>{bast.suratJalan.jobOrder.sealNumber1}</td>
                </tr>
              </tbody>
            </table>
            <table>
              <tbody>
                <tr>
                  ...
                  <td style={{ paddingRight: "0.5rem" }}>:</td>
                  <td>{bast.suratJalan.jobOrder.containerNumber2 || "-"}</td>
                </tr>
                <tr>
                  <td style={{ paddingRight: "0.5rem" }}>Seal Number 2</td>
                  <td style={{ paddingRight: "0.5rem" }}>:</td>
                  <td>{bast.suratJalan.jobOrder.sealNumber2 || "-"}</td>
                </tr>
              </tbody>
            </table>
          </Flex>
